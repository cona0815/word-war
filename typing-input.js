...
(() => {
  ...
  document.addEventListener('keydown', event => {
    if(!state.running||!mission.classList.contains('hidden')||drawer.classList.contains('open')||document.querySelector('#gmPanel')?.open||event.isComposing||event.keyCode===229||composing)return;
